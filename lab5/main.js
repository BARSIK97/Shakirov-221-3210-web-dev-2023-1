...
function downloadData(page = 1, query = '') {
    ...
    url.searchParams.append('q', query); // добавляем параметр q
...
function sAutocomplete(suggestionList) {
...
window.onload = function () {
    ...
    document.querySelector('.search-field').addEventListener('input', gAutocomplete);
}; 